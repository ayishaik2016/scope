...
class SIP_T57W extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T57W</h1>
    		<div >
				  ...
				  <Tab eventKey="home" title="Overview">
				    ...
				    <div class="yealink-tab-cnt">
				    	<div class="row" style={{margin:"0"}}>
				    		<div class="col-md-6">
				    			<img class="img-fluid" src={t57w} />
				    		</div>
				    		<div class="col-md-6">
				    			<h3 class="yealink_pro_sub_head">Prime Business Phone T57W</h3>
				    			<p class="yealink_pro_para">Premium-level phone for executives and busy managers with heavy call load</p>
				    			<ul class="yealink_pro_para">
						    		<li>7” 800x480-pixel colour touch display, fully adjustable</li>
						    		<li>HD Voice with Yealink Acoustic Shield technology</li>
						    		<li>29 touch keys, 16 SIP accounts</li>
				    ...
				    <div class="yealink-tab-cnt">
				    	<table class="table table-bordered">
						  <tbody>
						    ...
						    <tr>
						      <td>LCD Display</td>
						      <td>7" 800 x 480 Pixels Color Display</td>
						    </tr>
						    <tr>
						      <td>LCD Type</td>
						      <td>Adjustable</td>
