...
class SIP_T53W extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T53W</h1>
    		<div >
				    	...
				    	<div class="row" style={{margin:"0"}}>
				    		...
				    		<div class="col-md-6">
				    			...
				    			<ul class="yealink_pro_para">
						    		...
						    		<li>Built-in Bluetooth, Wi-Fi (T53W)*</li>
				    ...
				    <div class="yealink-tab-cnt">
				    	<table class="table table-bordered">
						  <tbody>
						    ...
						    <tr>
						      <td>LCD Display</td>
						      <td>3.7" 360 x 160 Pixels Graphical Display</td>
						    </tr>
						    <tr>
						      <td>LCD Type</td>
						      <td>Adjustable</td>
