...
import t41s1 from '../../img/yealink/t41s1.png';
import t41s2 from '../../img/yealink/t41s2.png';
...
class SIP_T41S extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T41S</h1>
    		<div >
