...
import t42s1 from '../../img/yealink/t42s1.png';
import t42s2 from '../../img/yealink/t42s2.png';
...
class SIP_T42S extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T42S</h1>
    		<div >
    			<Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
				  <Tab eventKey="home" title="Overview">
				    <div class="yealink-tab-cnt">
				    	...
				    	<img class="img-fluid" src={t42s1} />
				    	<img class="img-fluid" src={t42s2} />
				  ...
				  <Tab eventKey="profile" title="Specifications">
				    <div class="yealink-tab-cnt">
				    	<table class="table table-bordered">
						  <tbody>
						    <tr class="head_tab">
						      <td colspan="3" >T42S</td>
						    </tr>
						    <tr>
						      <td>LCD</td>
						      <td>2.7" graphical LCD</td>
