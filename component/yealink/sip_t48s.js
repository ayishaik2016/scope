...
import t48s1 from '../../img/yealink/t48s1.png';
import t48s2 from '../../img/yealink/t48s2.png';
import t48s3 from '../../img/yealink/t48s3.png';
import t48s4 from '../../img/yealink/t48s4.png';
import t48s5 from '../../img/yealink/t48s5.png';
import t48s6 from '../../img/yealink/t48s6.png';
import t48s7 from '../../img/yealink/t48s7.png';
import t48s8 from '../../img/yealink/t48s8.png';
...
class SIP_T48S extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T48S</h1>
    		<div >
    			<Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
				  <Tab eventKey="home" title="Overview">
				    <div class="yealink-tab-cnt">
				    	...
				    	<img class="img-fluid" src={t48s1} />
				    	<img class="img-fluid" src={t48s2} />
				    	


				    	
				    	<h3 class="yealink_pro_sub_head">Large Interactive Digital Display (Paperless)</h3>
				    	<p class="yealink_pro_para">The user-oriented design concept of the T4 series delivers a friendly interface and easy operation. The series offers large high-definition screens for a pleasant visual experience, from the flagship model SIP-T48S's 7-inch TFT LCD display with touch screen to the grey-scale backlit graphical LCD of the SIP-T41P. An abundance of multifunction DSS keys that incorporate red and green lights allow for customized programming to increase productivity.</p>

				    	<img class="img-fluid" src={t48s3} />
				    	...
				    	<img class="img-fluid" src={t48s8} />

				    	<div class="row" style={{margin:"0"}}>
				    		<div class="col-md-5"><img class="img-fluid" src={t48s9} /></div>
				    		<div class="col-md-7">
					    		<h3 class="yealink_pro_sub_head">Bluetooth and USB Support</h3>
						    	<p class="yealink_pro_para">The SIP-T48S and the SIP-T46S provide a built-in USB port and support for Bluetooth headsets. A hands-free connection gives you more freedom and comfort at work.</p>
					    	</div>
				    	</div>
				  ...
				  <Tab eventKey="profile" title="Specifications">
				    <div class="yealink-tab-cnt">
				    	<table class="table table-bordered">
						  <tbody>
						    <tr class="head_tab">
						      <td colspan="3" >T48S</td>
						    </tr>
						    <tr>
						      <td>LCD</td>
						      <td>7" colour touch screen</td>
