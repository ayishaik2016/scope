...
class SIP_T58A extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T58A with Camera</h1>
    		<div >
				  ...
				  <Tab eventKey="home" title="Overview">
				    <div class="yealink-tab-cnt">
				    	<div class="row" style={{margin:"0"}}>
				    		...
				    		<div class="col-md-6">
				    			<h3 class="yealink_pro_sub_head">Smart Business Phone SIP-T58A with Camera</h3>
