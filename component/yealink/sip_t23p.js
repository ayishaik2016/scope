...
import t23p1 from '../../img/yealink/t23p1.png';
...
class SIP_T23P extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink SIP-T23P</h1>
    		<div >
    			<Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
				  <Tab eventKey="home" title="Overview">
				    <div class="yealink-tab-cnt">
				    	...
				    	<p class="yealink_pro_para">Yealink HD Voice refers to the combination of software and hardware design as well as the implementation of wideband technology to maximize the acoustic performance. Coupled with advanced acoustic clarity technology such as full duplex, echo cancellation, adaptive jitter buffer etc., the SIP-T23P provides clearer, more lifelike voice communications.</p>
				    	...
				    	<p class="yealink_pro_para">The SIP-T23P supports vast productivity-enhancing features such as XML Browser, call park, call pickup, BLF, call forward, call transfer, 3-way conference, which makes it the natural and obvious efficiency tool for today’s busy small and large offices environment.</p>

				    	
				    	
				    	<h3 class="yealink_pro_sub_head text-left" style={{padding:"0"}}>Efficient Installation and Provisioning</h3>
				    	<p class="yealink_pro_para">The Yealink SIP-T23P supports efficient provisioning and effortless mass deployment with Yealink’s Redirection and Provisioning Service (RPS) and Boot mechanism to help you realize the Zero Touch Provisioning without any complex manual settings, which makes the SIP-T23P simple to deploy, easy to maintain and upgrade.</p>
