...
class Partners extends Component {
  ...
  componentDidMount() {
    ...
    firebase.database().ref().child('partners').once('value').then(snapshot => {
      let allNotes = [];
  ...
  delete = id => () => {
    ...
    firebase.database().ref().child('partners').orderByChild('id').equalTo(id).once('value').then(snapshot => {
      let allNotes = [];
      let key_temp = [];
      snapshot.forEach(snap => {
        allNotes.push(snap.val());
      ...
      firebase.database().ref('partners/' + key_temp).remove()
  ...
  writeprojectData() {
    ...
    if (img_url) {
      ...
      firebase.database().ref().child('partners').push(
        {
          // name:name,
  ...
  upload(e) {
    ...
    task.on('state_changed',
      () => {
        ...
        firebase.storage().ref('partners').child(str_name).getDownloadURL()
          .then(fireBaseUrl => {
            // alert(fireBaseUrl);
            ...
            <div class="navbar-inner">
              ...
              <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <Link className="nav-link active" to={"/admin/Partners"}>
                          ...
                          {this.state.messages.map(note => {
                            return (
                              <div class="col-md-2">
                                ...
                                <h6 style={{ color: "blue", cursor: "pointer" }} onClick={this.delete(note.id)}>Delete</h6>
                              </div>
                  ...
                  <div class="card-header border-0">
                    <div class="row align-items-center">
                      ...
                      <div class="col-md-6">
                        ...
                        <p style={{ color: "red", fontSize: "12px" }}>Image Size:420px Width, 280px Height</p>
                      </div>
                      <div class="col-md-2">
