...
import img6 from'../img/service5.png';
...
class Yealink_Product extends Component{
render(){
  return (
    <div className="App">
    	<Nav1/>
    	...
    	<div class="container">
    		<h1 class="yealink_pro_head">Yealink CP960 Conference Phone - Wireless Mic</h1>
    		<div >
...
export default Yealink_Product;
