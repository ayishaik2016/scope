...
*/}
  ...
  <li><Link className="" to={"/Laundry"} style={{color:"inherit"}}>Laundry</Link></li>
              ...
              <div class="col-md-4 contact">
                ...
                <ul class="reset">
                  <li>
                    ...
                    <a href="tel:+920012265" style={{ color: "inherit" }} target="_blank">+920012265</a>
                  </li>
                  <li>
              ...
              <div class="col-md-4 contact">
                ...
                <ul class="reset">
                  <li><i class="fa fa-map-marker"></i> <a href="https://g.page/scope-technol?share" style={{ color: "inherit" }} target="_blank">Exit 7, Northern Ring Rd. Riyadh, Saudi Arabia</a></li>
          ...
          <div class="copyright full_row">
            <div class="container">
              ...
              <p class="full_row text-center">© 2022 Scope Tech All rights reserved.</p>
            </div>
          </div>
